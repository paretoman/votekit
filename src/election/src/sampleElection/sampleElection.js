...
export default function sampleElection(samplingGeometry, electionOptions, numSamples, rng) {
    const { voterGeoms, canDnGeoms, dimensions, geography, canDnCDF, strategySeed, voterStrategyList, information } = samplingGeometry
    ...
    for (let i = 0; i < numSamples; i++) {
        ...
        const geometry = { voterGeoms, canPoints, parties, dimensions, geography, canBorders, strategySeed, voterStrategyList, information }
