...
export default function sainteLague({ votes, electionMethodOptions }) {
    const socialChoiceResults = divisorGeneral({ votes, electionMethodOptions, typeOfDivisor: 'sainteLague' })
