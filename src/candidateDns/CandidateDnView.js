 ...
 * @constructor
 */
export default function CandidateDnView(canDn, screen, election, wHandle, hHandle, viewSettings, simOptions) {
    const self = this
    self.canDn = canDn

    self.graphic = new CandidateDnGraphic(canDn, screen, election, wHandle, hHandle, viewSettings, simOptions)
}
